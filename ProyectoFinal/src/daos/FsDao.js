...
var fileOrdenes = "./data/ordenes.txt";
var FsDao = /** @class */ (function () {
    ...
    ;
    FsDao.prototype.agregarProdsCarrito = function (id, cantidad) {
        return __awaiter(this, void 0, void 0, function () {
    ...
    ;
    FsDao.prototype.generarOrden = function (userMail, prodList) {
        return __awaiter(this, void 0, void 0, function () {
            var ordenes, _a, _b, error_13;
            return __generator(this, function (_c) {
                switch (_c.label) {
                    case 0:
                        ordenes = [];
                    ...
                    case 1:
                        _c.trys.push([1, 3, , 4]);
                        _b = (_a = JSON).parse;
                        return [4 /*yield*/, fs_1.default.promises.readFile(fileOrdenes, "utf-8")];
                    case 2:
                        ordenes = _b.apply(_a, [_c.sent()]);
                        return [3 /*break*/, 4];
                    case 3:
                        error_13 = _c.sent();
                    ...
                    case 4:
                        ...
                        return [4 /*yield*/, fs_1.default.promises.writeFile(fileOrdenes, JSON.stringify(this.orden, null, "\t"), "utf-8")];
                    case 5:
                        _c.sent();
                        return [2 /*return*/, this.orden.id];
                }
            });
        });
    };
