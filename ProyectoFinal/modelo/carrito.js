...
var Carrito = /** @class */ (function () {
    ...
    ;
    Carrito.prototype.agregarProdsCarrito = function (id, cantidad) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 2, , 3]);
                        return [4 /*yield*/, server_1.dao.agregarProdsCarrito(id, cantidad)];
                    case 1:
                        response = _a.sent();
                    ...
                    case 2:
                        ...
                        if (rows) {
                            for (_i = 0, rows_1 = rows; _i < rows_1.length; _i++) {
                                row = rows_1[_i];
                                if (row) {
                                    listaProductos.push({ code: row["code"], title: row["title"], description: row["description"], price: row["price"], thumbnail: row["thumbnail"], stock: row["stock"], timestamp: row["timestamp"], cantidad: row["cantidad"], id: row["id"] });
                                }
                            }
                        }
    ...
    ;
    Carrito.prototype.generarOrden = function (userMail, prodList) {
        return __awaiter(this, void 0, void 0, function () {
            var ordenNro, error_5;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        console.log("entro a generar orden en modelo carrito");
                        _a.label = 1;
                    case 1:
                        _a.trys.push([1, 3, , 4]);
                        return [4 /*yield*/, server_1.dao.generarOrden(userMail, prodList)];
                    case 2:
                        ordenNro = _a.sent();
